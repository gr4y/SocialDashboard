<form method="post" action="/users/<?= $action; ?>" name="user" class="ui form">
...
<?php endif; ?>
  ...
  <button type="submit" class="ui button primary"><?php if($action == 'update'): ?>Aktualisieren<?php else: ?>Registrieren<?php endif; ?></button>
